...
for data_mode in data_modes:
    ...
    for data_dir in data_dirs:
        ...
        Path(f"./RQ4/user_ratio/result").mkdir(parents=True, exist_ok=True)
        res_df.to_csv(f"./RQ4/user_ratio/result/{data_mode}_{data_dir}.csv")
